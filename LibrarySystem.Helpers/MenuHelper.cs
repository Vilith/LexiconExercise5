...
using SearchOptions = LibrarySystem.Shared.SearchOptions;
...
namespace LibrarySystem.Helpers
{
    public static class MenuHelper
    {
        ...
        {
            ShowEnumMenu<MenuOption>("Main Menu");
        }

        public static void ShowRemoveBookMenu()
        {
            ShowEnumMenu<RemoveBookOption>("Return Book Menu");
        }

        public static void ShowListBooksMenu()
        {
            ShowEnumMenu<ListBooksOption>("List Books Menu");
        }

        public static void ShowSearchMenu()
        {
            ShowEnumMenu<SearchOptions>("Search Menu");
        }

        public static void ShowJsonMenu()
        {
            ShowEnumMenu<JsonOption>("JSON Menu");
        }
